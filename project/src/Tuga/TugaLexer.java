...
public class TugaLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"T__9", "T__10", "END_INST", "LPAREN", "RPAREN", "SUM", "SUB", "MLT", 
			"DIV", "MOD", "LESS", "GREATER", "LESS_EQ", "GREATER_EQ", "EQUALS", "N_EQUALS", 
			"AND", "OR", "NOT", "T_INT", "T_DOUBLE", "T_STRING", "T_BOOL", "INT", 
			"DOUBLE", "STRING", "TRUE", "FALSE", "ID", "WS", "SL_COMMENT", "ML_COMMENT"
		};
	}
